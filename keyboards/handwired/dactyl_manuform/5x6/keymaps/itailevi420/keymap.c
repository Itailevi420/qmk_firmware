...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_COLMAK] = LAYOUT_5x6(
     ...
     KC_LSFT, KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  ,                         KC_K  , KC_M  ,KC_COMM,KC_DOT ,KC_SLSH,RSFT_T(KC_BSLS),
                      KC_LBRC, KC_RBRC,                                                               LOWER1, KC_EQL,
                                      KC_SPC,KC_BSPC,                         LT(_RAISE,KC_ENT),KC_SPC,
                                      KC_LGUI,KC_LCTL,                        KC_RCTL, LOWER,
                                      LT(_SWITCH,KC_ENT), KC_LALT,            KC_RALT , KC_LGUI
  ),
  ...
  [_RAISE] = LAYOUT_5x6(
       ...
       _______,KC_NO,KC_NO,KC_NO,KC_NO,KC_LBRC,                                KC_RBRC,KC_PSCR,KC_NUM,KC_INS ,KC_SCRL,KC_MUTE,
 ...
 [_SWITCH] = LAYOUT_5x6(
     ...
     KC_NO, KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO,                           KC_NO  , KC_NO  ,KC_NO,KC_NO ,KC_NO,RSFT_T(KC_BSLS),
                      _______,_______,                                                       _______, _______,
                                      _______,_______,                        _______, _______,
                                      _______,_______,                         _______,  _______,
                                      _______, _______,                        _______, _______
